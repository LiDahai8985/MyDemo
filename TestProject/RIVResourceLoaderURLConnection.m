...
- (instancetype)initWithIdentifier:(NSString *)identifier
{
    ...
    if (self) {
        ...
        _mediaPath = [document stringByAppendingPathComponent:[NSString stringWithFormat:@"%@",identifier]];
        self.mediaIdentifier = identifier;
    }
    return self;
}
...
- (void)dealWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest
{
    ...
    if (!self.task) {
        self.task = [[RIVMediaRequestTask alloc] initWithIdentifier:self.mediaIdentifier];
